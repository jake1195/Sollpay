                  ...
                  <ModalDialog>
                    ...
                    <form
                      onSubmit={(event) => {
                        ...
                        // Check if the message contains the phone name "LEONARD KIPMUTAI"
                        if (!mpesaMessage.includes("LEONARD KIPMUTAI")) {
                          setMessageError(true);
                          return;
                        } else {
                        ...
                        setTimeout(() => {
                          ...
                          setMpesaCodeList((prev) => ([...prev, mpesaMessage.split(' 0738289657')[0]]));
                          setProgress(false);
                          navigate("/home");
                        }, 5000);
                      }}
                    >
                      <Stack spacing={2}>
                        <Textarea
                          ...
                          error={messageError}
                          helperText={messageError ? "Please paste a valid M-PESA message containing 'LEONARD KIPMUTAI'" : ""}
                          required
                        />
